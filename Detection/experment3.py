...
def setup_cfg():
    """
    Sets up the Detectron2 configuration for Experiment ID 3.
    """
    cfg = get_cfg()
    ...
    cfg.SOLVER.BASE_LR = 0.0005   # Increased learning rate for Experiment ID 3
    cfg.SOLVER.MAX_ITER = 1000    # Early stopping to avoid overfitting
    ...
    cfg.OUTPUT_DIR = "./output_experiment_3"
