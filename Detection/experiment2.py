...
def setup_cfg():
    """
    Sets up the Detectron2 configuration for Experiment ID 2.
    """
    cfg = get_cfg()
    ...
    cfg.SOLVER.BASE_LR = 0.0001   # Reduced learning rate for Experiment ID 2
    ...
    cfg.OUTPUT_DIR = "./output_experiment_2"
