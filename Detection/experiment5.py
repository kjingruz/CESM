...
def setup_cfg():
    """
    Sets up the Detectron2 configuration for Experiment ID 5.
    """
    cfg = get_cfg()
    ...
    cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 256  # Increased ROI batch size for Experiment ID 5
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = 3  # 0: Normal, 1: Benign, 2: Malignant

    cfg.OUTPUT_DIR = "./output_experiment_5"
    os.makedirs(cfg.OUTPUT_DIR, exist_ok=True)

    # Include images without annotations
    cfg.DATALOADER.FILTER_EMPTY_ANNOTATIONS = False  # Include images without annotations
