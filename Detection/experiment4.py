...
def setup_cfg():
    """
    Sets up the Detectron2 configuration for Experiment ID 4.
    """
    cfg = get_cfg()
    ...
    cfg.SOLVER.BASE_LR = 0.0005   # Adjusted learning rate for the new batch size
    ...
    cfg.OUTPUT_DIR = "./output_experiment_4"
