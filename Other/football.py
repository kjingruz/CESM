...
Original file is located at
    https://colab.research.google.com/drive/1k_ShTnknlXVnkxm9nuYQalI1vxcVdPhy
"""
...
data_dir = "./football-players-detection-12"
...
register_coco_instances("football_train", {}, train_json, train_img_dir)
register_coco_instances("football_val", {}, val_json, val_img_dir)

mri_metadata = MetadataCatalog.get("football_train")
dataset_dicts = DatasetCatalog.get("football_train")
...
evaluator = COCOEvaluator("football_val", cfg, False, output_dir=cfg.OUTPUT_DIR)
val_loader = build_detection_test_loader(cfg, "football_val")
print(inference_on_dataset(predictor.model, val_loader, evaluator))

dataset_dicts_val = DatasetCatalog.get("football_val")
