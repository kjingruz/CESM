...
from detectron2.data import detection_utils as utils  # Add this import
...
class AlbumentationsMapper(DatasetMapper):
    def __init__(self, cfg, is_train=True):
        ...
        self.albu_transform = A.Compose([
            ...
            A.CLAHE(clip_limit=(1, 4), tile_grid_size=(8, 8), always_apply=False, p=0.5),
            A.RandomGamma(gamma_limit=(80, 120), always_apply=False, p=0.5),
            A.ImageCompression(quality_lower=85, quality_upper=95, always_apply=False, p=0.5),
...
class EarlyStoppingHook(HookBase):
    ...
    def after_step(self):
        ...
        if next_iter % self.eval_period == 0:
            ...
            fitness = results['bbox']['AP']  # You can modify this metric as needed
...
def setup_cfg():
    ...
    cfg.OUTPUT_DIR = "./improved_output_augmented"
